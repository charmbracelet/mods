...
var help = map[string]string{
	...
	"claude-code-continue": "Continue the most recent Claude Code session (claude-code API only)",
	"claude-code-resume":   "Resume a Claude Code session by ID (claude-code API only)",
...
type Config struct {
	...
	ClaudeCodeContinue  bool       `yaml:"claude-code-continue"`
	ClaudeCodeResume    string     `yaml:"claude-code-resume"`
	APIs                APIs       `yaml:"apis"`
